...
from bert_dataset import WCSTBertDataset
# NOTE: train_bert_fixed executes top-level code on import which can cause issues.
# To avoid importing side-effects we redefine a small copy of analyze_interpretability
# here and use it instead of importing the module-level function.
...
def main():
    ...
    import os
    ck = '/home/olik/NLP/Project_NLP/best_bert_fixed.pt'
    ...
    head_scores = analyze_interpretability_local(test_loader, encoder, comparator, device, max_batches=20,
                                                 out_prefix='/home/olik/NLP/Project_NLP/interpret')
